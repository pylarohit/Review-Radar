        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {paginatedProducts.map((product) => {
            ...
            return (
              ...
              >
                <div>
                  <span className="text-[10px] font-bold uppercase tracking-wider text-violet-650 bg-violet-50 px-2.5 py-0.5 rounded-full border border-violet-100">
                    {product.category}
                  </span>

                  <h3 className="mt-4 text-base font-bold text-zinc-900 line-clamp-2 group-hover:text-violet-655 transition-colors">
                    {product.name}
                  </h3>
    ...
    <div className="w-full h-full flex overflow-hidden">
      ...
      {isMobileSidebarOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          {/* Drawer content */}
          <aside className="relative flex w-72 max-w-xs flex-col bg-white p-6 shadow-xl animate-in slide-in-from-left duration-300 h-full">
            <div className="flex items-center justify-between border-b border-zinc-150 pb-3 mb-4">
              <h2 className="font-extrabold text-[11px] text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : "text-zinc-655 border-transparent hover:text-zinc-900 hover:bg-zinc-50"
                      )}
                      title={product.name}
                    >
                      {product.name}
              ...
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="lg:hidden flex items-center gap-1.5 px-3 py-2 rounded-xl bg-violet-50 text-violet-750 border border-violet-100 hover:bg-violet-100 font-bold text-xs transition-all cursor-pointer shadow-sm"
                  >
